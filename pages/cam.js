  ...
  return (
    <div className="wrapper photo_head">
      <div className="text-center mt-5 text-5xl">
        <span className="headd">HBD CAM</span>
        <span>📷</span>{" "}
      </div>
      <div className="py-10 flex flex-col items-center space-y-4">
        <span className="text-lg ">생일자와 함께 기념 사진을 찍어보세요!</span>
      ...
      <div className="text-center">
        (저장된 사진은 우클릭으로 저장 가능합니다.)
      </div>
      {imgSrc && (
        <div className="flex flex-col items-center pt-[10px] pr-[10px] pb-[30px] pl-[10px]">
